...
export async function GET(request: NextRequest) {
  try {
    console.log('🔍 [LMS Stats GET] Debug Info:', {
      url: `${API_BASE_URL}/progress/stats`,
    ...
    console.log('📡 [LMS Stats GET] API Response:', {
    ...
    console.log('📦 [LMS Stats GET] Response Data:', data);
    ...
    console.error('❌ [LMS Stats GET] Error:', error);
