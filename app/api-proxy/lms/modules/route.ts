...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('🔍 [LMS Modules GET] Debug Info:', {
      url: `${API_BASE_URL}/content/modules${queryString ? `?${queryString}` : ''}`,
    ...
    const response = await fetch(
      `${API_BASE_URL}/content/modules${queryString ? `?${queryString}` : ''}`,
      {
        method: 'GET',
        headers,
      }
    ...
    console.log('📡 [LMS Modules GET] API Response:', {
    ...
    console.log('📦 [LMS Modules GET] Response Data:', data);
    ...
    console.error('❌ [LMS Modules GET] Error:', error);
