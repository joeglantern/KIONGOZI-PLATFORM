...
export default function MyLearningError({
    ...
    useEffect(() => {
        console.error('[MyLearningError]', error);
    }, [error]);
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-12 max-w-md w-full text-center">
                ...
                <h2 className="text-2xl font-black text-gray-900 mb-2">Couldn't load your courses</h2>
                <p className="text-gray-500 text-sm mb-8">
                    There was a problem fetching your enrolled courses. Your progress is safe.
                </p>
