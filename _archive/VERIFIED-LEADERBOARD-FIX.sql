-- ============================================
-- VERIFIED LEADERBOARD FIX
-- ✅ Confirmed based on actual schema inspection
-- Profiles table uses: id, email, full_name, total_xp, level
-- No user_id, no courses_completed columns
-- ============================================
...
BEGIN
  ...
  RAISE NOTICE '✅ Correct level formula: FLOOR(SQRT(total_xp / 50))';
  RAISE NOTICE '✅ Stats calculated dynamically from course_enrollments, user_progress, user_badges';
  RAISE NOTICE '✅ For 792 XP: Level = FLOOR(SQRT(792/50)) = FLOOR(3.98) = 3';
  RAISE NOTICE '';
