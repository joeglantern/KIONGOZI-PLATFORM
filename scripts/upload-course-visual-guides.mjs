...
const manifestPath = path.resolve('output/pdf/course-visual-guides-manifest.json');
...
const outputPath = path.resolve('output/pdf/course-visual-guides-uploaded.json');
